...
export const FALLBACK_QUICK_CATEGORIES: FallbackQuickCategory[] = [
  { id: 1, sectionId: null, icon: "Building2", title: "Hotels", titleHe: "מלונות", subtitle: "Find your perfect stay", subtitleHe: "מצאו את המקום המושלם לשהות", linkUrl: "/hotels", sortOrder: 1, isActive: true },
  { id: 2, sectionId: null, icon: "Compass", title: "Attractions", titleHe: "אטרקציות", subtitle: "Discover must-see places", subtitleHe: "גלו מקומות חובה", linkUrl: "/attractions", sortOrder: 2, isActive: true },
  { id: 3, sectionId: null, icon: "Utensils", title: "Restaurants", titleHe: "מסעדות", subtitle: "Explore dining options", subtitleHe: "חקרו אפשרויות אוכל", linkUrl: "/restaurants", sortOrder: 3, isActive: true },
  { id: 4, sectionId: null, icon: "Star", title: "Things to Do", titleHe: "דברים לעשות", subtitle: "Activities and experiences", subtitleHe: "פעילויות וחוויות", linkUrl: "/things-to-do", sortOrder: 4, isActive: true },
  { id: 5, sectionId: null, icon: "Newspaper", title: "Travel News", titleHe: "חדשות נסיעות", subtitle: "Latest travel updates", subtitleHe: "עדכוני נסיעות אחרונים", linkUrl: "/news", sortOrder: 5, isActive: true },
  { id: 6, sectionId: null, icon: "BookOpen", title: "Travel Guides", titleHe: "מדריכי טיול", subtitle: "Complete destination guides", subtitleHe: "מדריכי יעד מלאים", linkUrl: "/travel-guides", sortOrder: 6, isActive: true },
];

export const FALLBACK_EXPERIENCE_CATEGORIES: FallbackExperienceCategory[] = [
  { id: 1, name: "Luxury Travel", nameHe: "טיולי יוקרה", description: "Premium travel experiences and exclusive destinations", descriptionHe: "חוויות נסיעה פרימיום ויעדים בלעדיים", slug: "luxury", image: "/experiences/experiences-luxury-resort-infinity-pool.webp", imageAlt: "Luxury resort with infinity pool", icon: "Sparkles", href: "/experiences/luxury", sortOrder: 1, isActive: true },
  { id: 2, name: "Adventure & Outdoors", nameHe: "הרפתקאות ושטח", description: "Thrilling outdoor experiences and adventures", descriptionHe: "חוויות שטח מרתקות", slug: "adventure", image: "/experiences/experiences-adventure-hiker-mountain-trail-snowy-peaks.webp", imageAlt: "Hiker on mountain trail", icon: "Tent", href: "/experiences/adventure", sortOrder: 2, isActive: true },
  { id: 3, name: "Family Travel", nameHe: "טיולים משפחתיים", description: "Family-friendly destinations and activities", descriptionHe: "יעדים ופעילויות ידידותיות למשפחה", slug: "family", image: "/experiences/picnic-modern-architecture-outdoor-activity.webp", imageAlt: "Family enjoying picnic", icon: "Baby", href: "/experiences/family", sortOrder: 3, isActive: true },
  { id: 4, name: "Budget Travel", nameHe: "טיולים חסכוניים", description: "Affordable travel options and destinations", descriptionHe: "אפשרויות נסיעה ויעדים במחירים נוחים", slug: "budget", image: "/experiences/solo-travel-backpack-map-camera-desert-architecture.webp", imageAlt: "Travel backpack with camera", icon: "Wallet", href: "/experiences/budget", sortOrder: 4, isActive: true },
  { id: 5, name: "Honeymoon & Romance", nameHe: "ירח דבש ורומנטיקה", description: "Romantic getaways and honeymoon destinations", descriptionHe: "בריחות רומנטיות ויעדי ירח דבש", slug: "romance", image: "/experiences/romantic-couple-beach-sunset-modern-architecture.webp", imageAlt: "Couple at sunset on beach", icon: "Heart", href: "/experiences/romance", sortOrder: 5, isActive: true },
  { id: 6, name: "Solo Travel", nameHe: "טיולים עצמאיים", description: "Perfect destinations for solo travelers", descriptionHe: "יעדים מושלמים למטיילים עצמאיים", slug: "solo", image: "/experiences/solo-traveler-canoe-mountain-lake-archway-reflection.webp", imageAlt: "Solo traveler in canoe", icon: "Backpack", href: "/experiences/solo", sortOrder: 6, isActive: true },
];
...
export const FALLBACK_REGION_LINKS: FallbackRegionLink[] = [
  ...
  { id: 2, regionName: "Asia", name: "Asia", nameHe: "אסיה", icon: "Globe", linkUrl: "/destinations/asia", links: [], destinations: [{ name: "Tokyo", slug: "/destinations/tokyo" }, { name: "Singapore", slug: "/destinations/singapore" }, { name: "Bangkok", slug: "/destinations/bangkok" }, { name: "Bali", slug: "/destinations/bali" }, { name: "Hong Kong", slug: "/destinations/hong-kong" }], sortOrder: 2, isActive: true },
  { id: 3, regionName: "Middle East", name: "Middle East", nameHe: "המזרח התיכון", icon: "Globe", linkUrl: "/destinations/middle-east", links: [], destinations: [{ name: "Dubai", slug: "/destinations/dubai" }, { name: "Abu Dhabi", slug: "/destinations/abu-dhabi" }, { name: "Ras Al Khaimah", slug: "/destinations/ras-al-khaimah" }, { name: "Istanbul", slug: "/destinations/istanbul" }], sortOrder: 3, isActive: true },
];

export const FALLBACK_DESTINATIONS: FallbackDestination[] = [
  { id: "dubai", name: "Dubai", country: "UAE", slug: "/destinations/dubai", cardImage: "/cards/dubai.webp", cardImageAlt: "Dubai cityscape", summary: "Ultramodern architecture, luxury shopping, desert adventures" },
  { id: "london", name: "London", country: "United Kingdom", slug: "/destinations/london", cardImage: "/cards/london.webp", cardImageAlt: "London cityscape", summary: "Iconic landmarks, royal palaces, world-class theater" },
  { id: "paris", name: "Paris", country: "France", slug: "/destinations/paris", cardImage: "/cards/paris.webp", cardImageAlt: "Paris cityscape", summary: "The City of Light with iconic landmarks and exquisite cuisine" },
  { id: "new-york", name: "New York", country: "USA", slug: "/destinations/new-york", cardImage: "/cards/new-york.webp", cardImageAlt: "New York cityscape", summary: "The city that never sleeps with world-famous attractions" },
  { id: "tokyo", name: "Tokyo", country: "Japan", slug: "/destinations/tokyo", cardImage: "/cards/tokyo.webp", cardImageAlt: "Tokyo cityscape", summary: "Ancient temples, cutting-edge technology, incredible food" },
  { id: "singapore", name: "Singapore", country: "Singapore", slug: "/destinations/singapore", cardImage: "/cards/singapore.webp", cardImageAlt: "Singapore cityscape", summary: "Futuristic gardens, diverse cuisine, clean streets" },
  { id: "bangkok", name: "Bangkok", country: "Thailand", slug: "/destinations/bangkok", cardImage: "/cards/bangkok.webp", cardImageAlt: "Bangkok cityscape", summary: "Ornate temples, bustling street markets, incredible food" },
  { id: "istanbul", name: "Istanbul", country: "Turkey", slug: "/destinations/istanbul", cardImage: "/cards/istanbul.webp", cardImageAlt: "Istanbul cityscape", summary: "Ancient bazaars, Byzantine treasures, Ottoman palaces" },
  { id: "barcelona", name: "Barcelona", country: "Spain", slug: "/destinations/barcelona", cardImage: "/cards/barcelona.webp", cardImageAlt: "Barcelona cityscape", summary: "Gaudi's masterpieces, Mediterranean beaches, tapas culture" },
  { id: "rome", name: "Rome", country: "Italy", slug: "/destinations/rome", cardImage: "/cards/rome.webp", cardImageAlt: "Rome cityscape", summary: "Ancient ruins, Renaissance art, authentic Italian cuisine" },
  { id: "amsterdam", name: "Amsterdam", country: "Netherlands", slug: "/destinations/amsterdam", cardImage: "/cards/amsterdam.webp", cardImageAlt: "Amsterdam cityscape", summary: "Charming canals, world-renowned museums, vibrant neighborhoods" },
  { id: "abu-dhabi", name: "Abu Dhabi", country: "UAE", slug: "/destinations/abu-dhabi", cardImage: "/cards/abu-dhabi.webp", cardImageAlt: "Abu Dhabi cityscape", summary: "Sheikh Zayed Mosque, world-class museums, luxurious desert experiences" },
  { id: "ras-al-khaimah", name: "Ras Al Khaimah", country: "UAE", slug: "/destinations/ras-al-khaimah", cardImage: "/cards/ras-al-khaimah.webp", cardImageAlt: "Ras Al Khaimah mountains and coastline", summary: "UAE's adventure capital with Jebel Jais, pristine beaches, and Wynn casino opening 2027" },
];

export const FALLBACK_HERO_SLIDES: FallbackHeroSlide[] = [
  { id: "fallback-1", imageUrl: "/hero/travi-world-mascot-colorful-pool-arches.webp", imageAlt: "Travi mascot at luxury pool", headline: "Complete Travel Information Database | Hotels, Attractions & Guides", headlineHe: "מאגר מידע מלא לטיולים", subheadline: "Expert hotel information, detailed attractions, dining recommendations, and insider travel tips", subheadlineHe: "מידע מקצועי על מלונות, אטרקציות ומסעדות", ctaText: "Explore", ctaTextHe: "חקרו", ctaLink: "/destinations", sortOrder: 1, isActive: true },
  { id: "fallback-2", imageUrl: "/hero/travi-world-mascot-canyon-viewpoint.webp", imageAlt: "Travi mascot in desert canyon", headline: "Discover Authentic Experiences | Local Insights & Hidden Attractions", headlineHe: "גלו חוויות אותנטיות", subheadline: "Uncover local experiences, hidden attractions, insider tips, and authentic destinations worldwide", subheadlineHe: "גלו חוויות מקומיות ואטרקציות נסתרות", ctaText: "Discover", ctaTextHe: "גלו", ctaLink: "/attractions", sortOrder: 2, isActive: true },
  { id: "fallback-3", imageUrl: "/hero/travi-world-mascot-rainy-city-street-shopping.webp", imageAlt: "Travi mascot in city street", headline: "Explore Hotels & Accommodations | Reviews, Prices & Information", headlineHe: "חקרו מלונות ומקומות לינה", subheadline: "Detailed hotel information, reviews, price comparisons, and booking tips for every destination", subheadlineHe: "מידע מפורט על מלונות, ביקורות והשוואות מחירים", ctaText: "Browse Hotels", ctaTextHe: "עיון במלונות", ctaLink: "/hotels", sortOrder: 3, isActive: true },
];
...
interface HomepageDbResult {
  ...
  regionLinks: unknown[];
  featuredDestinations: Array<{ id: string; cardImage: string | null; slug?: string; [key: string]: unknown }>;
  hero: { slides: unknown[] };
  [key: string]: unknown;
}
...
export function makeRenderSafeHomepageConfig<T extends HomepageDbResult>(dbResult: T): T {
  ...
  const fallbacksApplied = Object.values(metrics).some(v => v === true || (typeof v === 'number' && v > 0));
  if (fallbacksApplied) {
