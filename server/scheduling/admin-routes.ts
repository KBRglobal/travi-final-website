...
export function registerSchedulingRoutes(app: Express): void {
   ...
   */
  app.post(
    "/api/admin/content/:id/cancel-schedule",
    requireAuth,
   ...
   */
  app.get(
    "/api/admin/content/:id/schedule-status",
    requireAuth,
    async (req: Request, res: Response) => {
      const { id } = req.params;
   ...
   */
  app.get(
    "/api/admin/content/schedule/upcoming",
    requireAuth,
    async (req: Request, res: Response) => {
   ...
   */
  app.get(
    "/api/admin/content/schedule/calendar",
    requireAuth,
    async (req: Request, res: Response) => {
      const now = new Date();
   ...
   */
  app.get(
    "/api/admin/content/schedule/failures",
    requireAuth,
    async (req: Request, res: Response) => {
   ...
   */
  app.get(
    "/api/admin/content/schedule/metrics",
    requireAuth,
    async (req: Request, res: Response) => {
      try {
