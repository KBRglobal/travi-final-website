...
export function registerAutoPilotRoutes(app: Express) {
  ...
  app.post(
    "/api/auto-pilot/scheduled/process",
    requirePermission("canManageSettings"),
    async (req, res) => {
      try {
  ...
  app.post(
    "/api/auto-pilot/translations/:contentId/trigger",
  ...
  app.post(
    "/api/auto-pilot/affiliates/:contentId",
    requirePermission("canEdit"),
    async (req, res) => {
      try {
        const { contentId } = req.params;
  ...
  app.post(
    "/api/auto-pilot/affiliates/bulk",
    requirePermission("canManageSettings"),
    async (req, res) => {
      try {
  ...
  app.post(
    "/api/auto-pilot/homepage/:contentId",
    requirePermission("canEdit"),
    async (req, res) => {
      try {
        const { contentId } = req.params;
  ...
  app.post(
    "/api/auto-pilot/homepage/rotate",
    requirePermission("canManageSettings"),
    async (req, res) => {
      try {
  ...
  app.post(
    "/api/auto-pilot/rss/:feedId/process",
    requirePermission("canManageSettings"),
    async (req, res) => {
      try {
  ...
  app.get("/api/auto-pilot/dashboard", requireAuth, async (req, res) => {
    try {
      ...
      const [
        ...
        db.select({ count: sql<number>`count(*)` }).from(affiliateLinks),
  ...
  app.post("/api/auto-pilot/bulk/approve", requirePermission("canPublish"), async (req, res) => {
    try {
      ...
      const inReviewContent = await db
        .select()
        .from(contents)
  ...
  app.post(
    "/api/auto-pilot/bulk/quality-check",
    requirePermission("canManageSettings"),
    async (req, res) => {
      try {
        const { db } = await import("./db");
  ...
  app.post(
    "/api/auto-pilot/bulk/seo-refresh",
    requirePermission("canManageSettings"),
    async (req, res) => {
      try {
        const { db } = await import("./db");
        ...
        const contentNeedingSeo = await db
          .select()
          .from(contents)
          .where(
            or(
  ...
  app.post(
    "/api/auto-pilot/rss/migrate-schema",
    requirePermission("canManageSettings"),
    async (req, res) => {
      try {
        const { db } = await import("./db");
  ...
  app.post(
    "/api/auto-pilot/rss/import-feeds",
    requirePermission("canManageSettings"),
    async (req, res) => {
      try {
        const { db } = await import("./db");
