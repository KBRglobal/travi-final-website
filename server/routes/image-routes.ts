...
export function registerImageRoutes(app: Express) {
  ...
  app.post(
    ...
    async (req: Request, res: Response) => {
      try {
        ...
        if (!imageContext) {
          return res.status(400).json({ error: "imageContext is required - describe what the image shows" });
        }
        ...
        console.error("[ImageRoutes] Alt-text generation error:", error);
  ...
  app.post(
    ...
    async (req: Request, res: Response) => {
      try {
        ...
        console.error("[ImageRoutes] Batch alt-text generation error:", error);
  ...
  app.post(
    ...
    async (req: Request, res: Response) => {
      try {
        ...
        console.error("[ImageRoutes] Alt-text validation error:", error);
  ...
  console.log("[ImageRoutes] AI alt-text endpoints available at /api/images/generate-alt-text");
