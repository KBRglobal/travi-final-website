...
export function registerLogRoutes(app: Express) {
   ...
   * Get log statistics
   */
  app.get("/api/admin/logs/stats", requirePermission("canManageSettings"), async (req: Request, res: Response) => {
    try {
   ...
   */
  app.get("/api/admin/logs/categories", requirePermission("canManageSettings"), async (req: Request, res: Response) => {
    try {
   ...
   */
  app.delete("/api/admin/logs", requirePermission("canManageSettings"), async (req: Request, res: Response) => {
    try {
      clearLogs();
  ...
  console.log("[LogRoutes] Registered log management endpoints at /api/admin/logs/*");
}
