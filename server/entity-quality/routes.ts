...
function requireEntityQualityEnabled(req: Request, res: Response, next: NextFunction): void {
...
router.get("/suggestions", requireEntityQualityEnabled, (req: Request, res: Response) => {
  try {
    ...
    const suggestions = querySuggestions({
      ...
      minConfidence: minConfidence ? Number.parseInt(minConfidence as string, 10) : undefined,
