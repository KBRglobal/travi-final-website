...
import { isEntityQualityEnabled, ENTITY_QUALITY_CONFIG } from '../../../server/entity-quality/config';
import {
  normalizeText,
  normalizePhone,
  normalizeWebsite,
...
describe('Entity Quality: Dedup Scanner', () => {
  ...
  describe('Normalizer', () => {
    it('should normalize text', () => {
      ...
      expect(normalizeText('Beach Club & Restaurant')).toBe('beach club  restaurant');
    });
  ...
  describe('Similarity Functions', () => {
    ...
    it('should calculate geo distance', () => {
      ...
      const distance = geoDistance(25.0808, 55.1376, 25.1124, 55.1390);
  ...
  describe('Match Calculation', () => {
    it('should calculate match between similar entities', () => {
      ...
      const entity2: EntityReference = {
        id: 'e2',
        type: 'hotel',
        name: 'Grand Hotel Dubai Marina',
        normalizedName: 'grand dubai marina',
        destinationId: 'dubai',
        latitude: 25.001,
        longitude: 55.001,
      };
