...
### Buttons
**Primary CTA**: Purple gradient bg (from-[#6443F4] to-[#8B5CF6]), rounded-full, px-8 py-4, white text, shadow-lg shadow-purple-500/25, hover:opacity-90

**Secondary**: Outline variant, border-slate-200, text-slate-700, rounded-2xl, hover border-[#6443F4]
...
**Editorial Card**: bg-white, rounded-3xl, overflow-hidden, shadow-2xl, hover shadow-purple-500/20

**Bento Card**: rounded-3xl overflow-hidden shadow-lg, gradient overlay from-slate-900/90 via-slate-900/30 to-transparent

**Micro Stats Card**: border border-slate-100, rounded-xl, p-6, hover border-[#6443F4]

### Badges
**Hero Badge**: bg-white shadow-lg shadow-purple-500/10 border border-purple-200, rounded-full, animated dot (animate-ping), text-[#6443F4]

**Gallery Featured Badge**: Gradient bg (from-[#6443F4] to-[#F24294]), text-white, rounded-full, px-4 py-2, shadow-lg

**Location Badge**: bg-white/95 backdrop-blur-md, rounded-2xl, p-4, shadow-lg, gradient icon circle

**Floating Info Card**: bg-white rounded-xl shadow-xl, gradient icon (emerald/amber), text-slate-900

### Hero Gallery Standard (Single Card + Carousel)
All category pages (Home, Destinations, Attractions, Hotels, Dining) use this consistent gallery format:
- Single large featured image card with rounded-3xl
- AnimatePresence carousel transitions
- Gradient overlay (from-slate-900/90 via-slate-900/30 to-transparent)
- Featured badge with gradient styling (NOT white bg)
- Content overlay: location, title, details, CTA
- Thumbnail strip: rounded-2xl bg-white/90 backdrop-blur-md
- Floating info cards with gradient icons

### H1 Standard (Gradient Word + Underline)
- 2-line H1 structure with Chillax font
- Line 1: Regular text (slate-900)
- Line 2: Single gradient word with animated-gradient-text class
- Gradient underline beneath gradient word: h-1 bg-gradient-to-r from-[#6443F4] via-[#8B5CF6] to-[#F24294]
