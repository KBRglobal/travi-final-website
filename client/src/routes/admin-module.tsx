...
const KeywordsPage = lazy(() => import("@/pages/admin/keywords"));
const ClustersPage = lazy(() => import("@/pages/admin/clusters"));
const TagsPage = lazy(() => import("@/pages/admin/tags"));
const AffiliateLinks = lazy(() => import("@/pages/admin/affiliate-links"));
const MediaLibrary = lazy(() => import("@/pages/admin/media-library"));
const ImageEngine = lazy(() => import("@/pages/admin/image-engine"));
const Settings = lazy(() => import("@/pages/admin/settings"));
const ContentRulesPage = lazy(() => import("@/pages/admin/content-rules"));
const UsersPage = lazy(() => import("@/pages/admin/users"));
const HomepagePromotions = lazy(() => import("@/pages/admin/homepage-promotions"));
const Analytics = lazy(() => import("@/pages/admin/analytics"));
const AuditLogs = lazy(() => import("@/pages/admin/audit-logs"));
const AdminLogs = lazy(() => import("@/pages/admin/AdminLogs"));
const NewsletterSubscribers = lazy(() => import("@/pages/admin/newsletter-subscribers"));
...
const ContentTemplatesPage = lazy(() => import("@/pages/admin/content-templates"));
const SEOAuditPage = lazy(() => import("@/pages/admin/seo-audit"));
const AutoPilotPage = lazy(() => import("@/pages/admin/auto-pilot"));
const SocialDashboard = lazy(() => import("@/pages/admin/social-dashboard"));
...
const DestinationsListPage = lazy(() => import("@/pages/admin/destinations-list"));
const DestinationHubPage = lazy(() => import("@/pages/admin/destination-hub"));
...
const VisualEditorDashboard = lazy(() => import("@/pages/admin/visual-editor-dashboard"));
const VisualEditorSiteEditor = lazy(() => import("@/pages/admin/visual-editor-site"));
...
const WritersManagement = lazy(() => import("@/pages/admin/writers-management"));
const NewsroomDashboard = lazy(() => import("@/pages/admin/newsroom-dashboard"));
const AdminChatInbox = lazy(() => import("@/pages/admin/admin-chat-inbox"));
const OctopusDashboard = lazy(() => import("@/pages/admin/octopus-dashboard"));
const TraviGeneratorDashboard = lazy(() => import("@/pages/admin/travi-generator-dashboard"));
...
const MonetizationListings = lazy(() => import("@/pages/admin/monetization/listings"));
const MonetizationLeads = lazy(() => import("@/pages/admin/monetization/leads"));
const MonetizationAffiliates = lazy(() => import("@/pages/admin/monetization/affiliates"));
...
const EnterpriseActivity = lazy(() => import("@/pages/admin/enterprise/activity"));
const GovernanceDashboard = lazy(() => import("@/pages/admin/governance/dashboard"));
...
const LiveConsole = lazy(() => import("@/pages/admin/live-console"));
const Surveys = lazy(() => import("@/pages/admin/surveys"));
const SurveyBuilder = lazy(() => import("@/pages/admin/surveys/builder"));
const SurveyResponses = lazy(() => import("@/pages/admin/surveys/responses"));
