...
export const destinationCategoryImages: Record<string, DestinationCategoryConfig> = {
  "abu-dhabi": {
    ...
    metaTags: {
      ...
      description: "Discover Abu Dhabi with TRAVI: Sheikh Zayed Mosque, Louvre Abu Dhabi, traditional Emirati heritage, luxury resorts, and desert experiences. Your 2025 Abu Dhabi guide.",
      keywords: "Abu Dhabi travel, Sheikh Zayed Mosque, Louvre Abu Dhabi, Emirati culture, Abu Dhabi desert safari, UAE capital travel guide 2025"
    }
  },
  ...
  amsterdam: {
    ...
    metaTags: {
      ...
      description: "Discover Amsterdam with TRAVI: explore canal cruises, Anne Frank House, Rijksmuseum, Dutch cuisine, and cycling culture. Complete 2025 guide with personalized recommendations.",
      keywords: "Amsterdam travel, Amsterdam attractions, canal cruises, Anne Frank House, Rijksmuseum, Dutch pancakes, Amsterdam cycling, flower market, Netherlands travel guide 2025"
    }
  },
  ...
  bangkok: {
    ...
    metaTags: {
      ...
      description: "Experience Bangkok with TRAVI: Wat Arun, Grand Palace, authentic street food markets, floating markets, and Thai cultural experiences. Your complete 2025 Bangkok guide.",
      keywords: "Bangkok travel, Bangkok temples, Wat Arun, Grand Palace, Thai street food, Bangkok night markets, Chao Phraya River, Thailand travel guide 2025"
    }
  },
  ...
  barcelona: {
    ...
    metaTags: {
      ...
      description: "Explore Barcelona with TRAVI: Sagrada Familia, Park Güell, Gothic Quarter, Mediterranean beaches, tapas bars, and Catalan culture. Complete 2025 Barcelona guide.",
      keywords: "Barcelona travel, Sagrada Familia, Park Güell, Gaudí architecture, Barcelona beaches, Spanish tapas, Las Ramblas, Catalonia Spain travel 2025"
    }
  },
  ...
  dubai: {
    ...
    metaTags: {
      ...
      description: "Discover Dubai with TRAVI: Burj Khalifa, Palm Jumeirah, desert safaris, luxury shopping, traditional souks, and world-class dining. Your 2025 Dubai guide.",
      keywords: "Dubai travel, Burj Khalifa, Palm Jumeirah, Dubai Marina, desert safari, Dubai Mall, traditional souks, UAE travel guide 2025"
    }
  },
  ...
  "hong-kong": {
    ...
    metaTags: {
      ...
      description: "Experience Hong Kong with TRAVI: Victoria Peak, Star Ferry, authentic dim sum, traditional temples, night markets, and fusion culture. Complete 2025 Hong Kong guide.",
      keywords: "Hong Kong travel, Victoria Harbour, Tian Tan Buddha, dim sum, Hong Kong skyline, Star Ferry, Temple Street Market, Hong Kong travel guide 2025"
    }
  },
  ...
  istanbul: {
    ...
    metaTags: {
      ...
      description: "Explore Istanbul with TRAVI: Hagia Sophia, Blue Mosque, Grand Bazaar, Bosphorus cruise, Turkish cuisine, and East-meets-West culture. Your 2025 Istanbul guide.",
      keywords: "Istanbul travel, Hagia Sophia, Blue Mosque, Grand Bazaar, Bosphorus, Turkish food, Sultanahmet, Turkey travel guide 2025"
    }
  },
  ...
  "las-vegas": {
    ...
    metaTags: {
      ...
      description: "Experience Las Vegas with TRAVI: The Strip, world-class shows, casino resorts, Fremont Street, buffets, and 24/7 entertainment. Complete 2025 Vegas guide.",
      keywords: "Las Vegas travel, Las Vegas Strip, Vegas shows, casino resorts, Fremont Street, Vegas buffets, Nevada travel guide 2025"
    }
  },
  ...
  london: {
    ...
    metaTags: {
      ...
      description: "Discover London with TRAVI: Buckingham Palace, British Museum, Tower of London, West End shows, afternoon tea, and British culture. Your 2025 London guide.",
      keywords: "London travel, Buckingham Palace, Tower of London, British Museum, Big Ben, afternoon tea, West End, UK travel guide 2025"
    }
  },
  ...
  "los-angeles": {
    ...
    metaTags: {
      ...
      description: "Explore LA with TRAVI: Hollywood Sign, Venice Beach, Getty Center, Santa Monica Pier, celebrity culture, and California sunshine. Complete 2025 Los Angeles guide.",
      keywords: "Los Angeles travel, Hollywood Sign, Venice Beach, Santa Monica, Griffith Observatory, LA beaches, California travel guide 2025"
    }
  },
  ...
  miami: {
    ...
    metaTags: {
      ...
      description: "Experience Miami with TRAVI: South Beach, Art Deco District, Wynwood Walls, Cuban cuisine, vibrant nightlife, and tropical paradise. Your 2025 Miami guide.",
      keywords: "Miami travel, South Beach, Art Deco District, Miami Beach, Wynwood Walls, Cuban food, Ocean Drive, Florida travel guide 2025"
    }
  },
  ...
  "new-york": {
    ...
    metaTags: {
      ...
      description: "Discover NYC with TRAVI: Statue of Liberty, Times Square, Central Park, Broadway shows, world-class museums, and diverse neighborhoods. Complete 2025 New York guide.",
      keywords: "New York travel, NYC attractions, Statue of Liberty, Times Square, Central Park, Broadway shows, Empire State Building, New York City guide 2025"
    }
  },
  ...
  paris: {
    ...
    metaTags: {
      ...
      description: "Explore Paris with TRAVI: Eiffel Tower, Louvre Museum, Notre-Dame, Champs-Élysées, French cuisine, and Parisian romance. Your complete 2025 Paris guide.",
      keywords: "Paris travel, Eiffel Tower, Louvre Museum, Notre-Dame, Champs-Élysées, French cuisine, Paris cafes, France travel guide 2025"
    }
  },
  ...
  rome: {
    ...
    metaTags: {
      ...
      description: "Discover Rome with TRAVI: Colosseum, Vatican City, Trevi Fountain, Roman Forum, authentic Italian cuisine, and ancient history. Complete 2025 Rome guide.",
      keywords: "Rome travel, Colosseum, Vatican City, Trevi Fountain, Roman Forum, Italian food, Rome attractions, Italy travel guide 2025"
    }
  },
  ...
  singapore: {
    ...
    metaTags: {
      ...
      description: "Experience Singapore with TRAVI: Marina Bay Sands, Gardens by the Bay, hawker centers, diverse culture, and modern architecture. Your 2025 Singapore guide.",
      keywords: "Singapore travel, Marina Bay Sands, Gardens by the Bay, Singapore hawker centers, Singapore food, Sentosa Island, Singapore guide 2025"
    }
  },
  ...
  tokyo: {
    ...
    metaTags: {
      ...
      description: "Explore Tokyo with TRAVI: Sensoji Temple, Shibuya Crossing, authentic sushi, traditional culture, cutting-edge technology, and Japanese hospitality. Complete 2025 Tokyo guide.",
      keywords: "Tokyo travel, Sensoji Temple, Shibuya Crossing, Tokyo sushi, Japanese culture, Tokyo attractions, Japan travel guide 2025"
    }
  }
};
