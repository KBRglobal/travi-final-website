...
const DESTINATION_MOODS: Record<DestinationId, DestinationMood> = {
  "abu-dhabi": { primaryColor: "hsl(35 100% 50%)", gradientFrom: "rgba(212, 175, 55, 0.4)", gradientTo: "rgba(139, 90, 43, 0.6)", vibe: "luxury", tagline: "Where Tradition Meets Tomorrow" },
  "amsterdam": { primaryColor: "hsl(25 80% 50%)", gradientFrom: "rgba(255, 140, 0, 0.3)", gradientTo: "rgba(100, 80, 60, 0.5)", vibe: "cultural", tagline: "Canals, Culture & Character" },
  "bangkok": { primaryColor: "hsl(45 100% 50%)", gradientFrom: "rgba(255, 215, 0, 0.4)", gradientTo: "rgba(180, 100, 50, 0.6)", vibe: "adventure", tagline: "The City That Never Sleeps" },
  "barcelona": { primaryColor: "hsl(15 85% 55%)", gradientFrom: "rgba(220, 100, 60, 0.4)", gradientTo: "rgba(100, 50, 80, 0.5)", vibe: "cultural", tagline: "Art, Architecture & Mediterranean Soul" },
  "dubai": { primaryColor: "hsl(35 100% 50%)", gradientFrom: "rgba(255, 200, 50, 0.4)", gradientTo: "rgba(100, 60, 30, 0.6)", vibe: "luxury", tagline: "The Future is Here" },
  "hong-kong": { primaryColor: "hsl(350 80% 55%)", gradientFrom: "rgba(200, 50, 70, 0.4)", gradientTo: "rgba(50, 50, 80, 0.6)", vibe: "modern", tagline: "Where East Meets West" },
  "istanbul": { primaryColor: "hsl(15 70% 50%)", gradientFrom: "rgba(180, 80, 60, 0.4)", gradientTo: "rgba(80, 40, 60, 0.6)", vibe: "cultural", tagline: "Bridging Continents & Centuries" },
  "las-vegas": { primaryColor: "hsl(280 70% 55%)", gradientFrom: "rgba(150, 50, 180, 0.4)", gradientTo: "rgba(50, 20, 80, 0.6)", vibe: "adventure", tagline: "Entertainment Capital of the World" },
  "london": { primaryColor: "hsl(220 50% 50%)", gradientFrom: "rgba(70, 90, 140, 0.4)", gradientTo: "rgba(40, 50, 80, 0.6)", vibe: "cultural", tagline: "History, Heritage & Innovation" },
  "los-angeles": { primaryColor: "hsl(35 90% 55%)", gradientFrom: "rgba(255, 180, 100, 0.4)", gradientTo: "rgba(100, 60, 80, 0.5)", vibe: "modern", tagline: "Dreams Start Here" },
  "miami": { primaryColor: "hsl(180 70% 50%)", gradientFrom: "rgba(50, 200, 200, 0.4)", gradientTo: "rgba(200, 100, 150, 0.5)", vibe: "tropical", tagline: "Where the Sun Always Shines" },
  "new-york": { primaryColor: "hsl(220 60% 50%)", gradientFrom: "rgba(60, 80, 140, 0.4)", gradientTo: "rgba(40, 40, 60, 0.6)", vibe: "modern", tagline: "The City That Never Sleeps" },
  "paris": { primaryColor: "hsl(330 50% 55%)", gradientFrom: "rgba(180, 100, 140, 0.4)", gradientTo: "rgba(60, 40, 60, 0.6)", vibe: "romantic", tagline: "The City of Light & Love" },
...
function createDestinationData(
  ...
  return {
    ...
    seo: {
      ...
      canonicalUrl: `https://travi.world/destinations/${id}`,
...
const baseDestinationData: Record<DestinationId, DestinationPageData> = {
  ...
  "amsterdam": createDestinationData(
    "amsterdam", "Amsterdam", "Netherlands", "EUR (Euro)", "Dutch, English"
  ),
  "bangkok": createDestinationData(
    "bangkok", "Bangkok", "Thailand", "THB (Baht)", "Thai, English"
  ),
  "barcelona": createDestinationData(
    "barcelona", "Barcelona", "Spain", "EUR (Euro)", "Spanish, Catalan"
  ),
  "dubai": createDestinationData(
    "dubai", "Dubai", "United Arab Emirates", "AED (Dirham)", "Arabic, English"
  ),
  "hong-kong": createDestinationData(
    "hong-kong", "Hong Kong", "China SAR", "HKD (Dollar)", "Cantonese, English"
  ),
  "istanbul": createDestinationData(
    "istanbul", "Istanbul", "Turkey", "TRY (Lira)", "Turkish, English"
  ),
  "las-vegas": createDestinationData(
    "las-vegas", "Las Vegas", "United States", "USD (Dollar)", "English, Spanish"
  ),
  "london": createDestinationData(
    "london", "London", "United Kingdom", "GBP (Pound)", "English"
  ),
  "los-angeles": createDestinationData(
    "los-angeles", "Los Angeles", "United States", "USD (Dollar)", "English, Spanish"
  ),
  "miami": createDestinationData(
    "miami", "Miami", "United States", "USD (Dollar)", "English, Spanish"
  ),
  "new-york": createDestinationData(
    "new-york", "New York", "United States", "USD (Dollar)", "English"
  ),
  "paris": createDestinationData(
    "paris", "Paris", "France", "EUR (Euro)", "French, English"
  ),
  "rome": createDestinationData(
    "rome", "Rome", "Italy", "EUR (Euro)", "Italian, English"
  ),
  "singapore": createDestinationData(
    "singapore", "Singapore", "Singapore", "SGD (Dollar)", "English, Mandarin"
  ),
...
const dubaiNeighborhoods = [
  {
    id: "downtown-dubai",
    name: "Downtown Dubai",
    description: "The heart of modern Dubai featuring the iconic Burj Khalifa, Dubai Mall, and Dubai Fountain. A premier destination for luxury shopping, fine dining, and world-class entertainment.",
    ...
    bestFor: ["Luxury travelers", "First-time visitors", "Shopping enthusiasts", "Architecture lovers"],
    nearbyAttractions: ["Burj Khalifa", "Dubai Mall", "Dubai Fountain", "Dubai Opera", "Souk Al Bahar"],
    quickInfo: [
    ...
    faq: [
      { question: "What is the best time to visit Downtown Dubai?", answer: "Visit in the evening to see the Dubai Fountain show (every 30 minutes from 6 PM) and the Burj Khalifa lit up against the night sky." },
      { question: "How do I get to Downtown Dubai?", answer: "Take the Dubai Metro Red Line to Burj Khalifa/Dubai Mall station. The area is also well-connected by taxi and ride-sharing apps." },
    ],
  ...
  },
  {
    id: "dubai-marina",
    name: "Dubai Marina",
    description: "A stunning waterfront community with impressive skyscrapers, yacht clubs, and a vibrant promenade. Perfect for those seeking an urban beach lifestyle.",
    highlights: ["Marina Walk", "Beach Access", "Nightlife", "Yacht Tours", "Fine Dining"],
    priceLevel: "$$$",
    imageUrl: "/images/categories/dubai/dubai-palm-jumeirah-marina-skyline-sunset-modern-architecture.webp",
    imageAlt: "Dubai Marina waterfront and skyscrapers",
    vibe: "Vibrant",
    introText: "Dubai Marina is one of the world's largest man-made marinas, featuring over 200 high-rise towers along a 3km stretch of waterfront. The Marina Walk promenade offers endless dining options, from casual cafes to upscale restaurants, all with stunning views of the yachts and towers.",
    ...
    faq: [
      { question: "Is Dubai Marina walkable?", answer: "Yes! The Marina Walk is a 7km pedestrian promenade perfect for walking, jogging, or cycling. Most attractions are within walking distance." },
      { question: "What is the nightlife like?", answer: "Dubai Marina has a vibrant nightlife scene with rooftop bars, lounges, and clubs. Popular spots include Pier 7 and the various hotel bars." },
    ],
  ...
  },
  {
    id: "palm-jumeirah",
    name: "Palm Jumeirah",
    description: "The world-famous palm-shaped island featuring luxury resorts, beachfront villas, and exclusive restaurants. An iconic symbol of Dubai's ambition.",
    highlights: ["Atlantis Resort", "Beach Clubs", "Luxury Hotels", "The Pointe", "Aquaventure"],
    priceLevel: "$$$$",
    imageUrl: "/images/categories/dubai/dubai-palm-jumeirah-marina-skyline-sunset-modern-architecture.webp",
    imageAlt: "Palm Jumeirah aerial view",
    vibe: "Luxury",
    introText: "Palm Jumeirah is an engineering marvel and one of the most recognizable landmarks in the world. This palm-shaped artificial island is home to some of Dubai's most exclusive hotels, including Atlantis The Palm, as well as private beach clubs, celebrity restaurants, and luxury villas.",
    bestFor: ["Honeymooners", "Luxury seekers", "Beach lovers", "Families with children"],
    nearbyAttractions: ["Atlantis The Palm", "Aquaventure Waterpark", "The Lost Chambers Aquarium", "The Pointe", "Nakheel Mall"],
    quickInfo: [
    ...
    faq: [
      { question: "How do I get to Palm Jumeirah?", answer: "Take the Palm Monorail from Gateway Station (connects to the tram), drive, or use taxi/rideshare. The Monorail offers the best views." },
      { question: "Can I visit Atlantis without staying there?", answer: "Yes! You can buy day passes for Aquaventure Waterpark, visit The Lost Chambers Aquarium, or dine at any of the restaurants." },
    ],
  ...
  },
  {
    ...
    description: "A beachfront community with a lively promenade, outdoor dining, and direct beach access. The Walk at JBR is perfect for families and beach lovers.",
    ...
    faq: [
      { question: "Is JBR Beach free?", answer: "Yes, JBR Beach is a public beach and completely free to access. Sunbeds and umbrellas can be rented for a fee." },
      { question: "What facilities are available?", answer: "JBR Beach has showers, changing rooms, lifeguards, watersports rentals, and numerous restaurants and cafes along The Walk." },
    ],
  ...
  },
  {
    ...
    description: "Experience authentic Dubai culture in the historic districts of Deira and Bur Dubai. Explore traditional souks, abra rides on Dubai Creek, and heritage sites.",
    highlights: ["Gold Souk", "Spice Souk", "Dubai Creek", "Al Fahidi", "Abra Rides"],
    priceLevel: "$",
    imageUrl: "/images/categories/dubai/dubai-old-town-wind-towers-colorful-traditional-architecture.webp",
    ...
    nearbyAttractions: ["Gold Souk", "Spice Souk", "Al Fahidi Historical District", "Dubai Museum", "Dubai Frame"],
    quickInfo: [
      { icon: "MapPin", label: "Location", value: "Central Dubai" },
    ...
    faq: [
      { question: "Is it safe to walk around Old Dubai?", answer: "Yes, Old Dubai is very safe to explore on foot. The streets can be busy and crowded, especially in the souks, so keep your belongings secure." },
      { question: "What is an abra?", answer: "An abra is a traditional wooden boat that crosses Dubai Creek. It's one of the oldest forms of transport in Dubai and costs just 1 AED for the crossing." },
    ],
  ...
  },
  {
    id: "business-bay",
    name: "Business Bay",
    description: "Dubai's central business district with modern high-rises, waterfront views along the Dubai Canal, and excellent connectivity to all areas.",
    ...
    bestFor: ["Business travelers", "Value seekers", "Modern architecture fans", "Canal-view lovers"],
    nearbyAttractions: ["Dubai Canal", "Bay Avenue Mall", "Downtown Dubai", "Dubai Design District"],
    quickInfo: [
      { icon: "MapPin", label: "Location", value: "Central Dubai" },
    ...
    faq: [
      { question: "Is Business Bay close to Downtown Dubai?", answer: "Yes, Business Bay borders Downtown Dubai and is a 5-10 minute walk from Burj Khalifa and Dubai Mall." },
      { question: "Is there nightlife in Business Bay?", answer: "Business Bay has a growing number of rooftop bars and restaurants, particularly along the canal. It's more sophisticated than nightclub-focused." },
    ],
  ...
  },
  {
    id: "jumeirah",
    name: "Jumeirah",
    description: "An upscale residential area known for its beautiful beaches, the iconic Burj Al Arab, and family-friendly atmosphere with excellent schools and parks.",
    ...
    faq: [
      { question: "Can I visit Burj Al Arab?", answer: "You can visit by booking afternoon tea, a restaurant reservation, or a guided tour. Advance booking is essential." },
      { question: "Is Jumeirah on the Metro?", answer: "No, Jumeirah is not directly served by the Metro. The best options are taxi, bus, or ride-sharing apps." },
    ],
  ...
  },
  {
    ...
    description: "The financial heart of the Middle East featuring world-class art galleries, high-end restaurants, and luxury boutiques in a sophisticated urban setting.",
    ...
    nearbyAttractions: ["Gate Village galleries", "Gate Avenue", "ICD Brookfield Place", "Opera Gallery"],
    quickInfo: [
      { icon: "MapPin", label: "Location", value: "Central Dubai" },
    ...
    faq: [
      { question: "Is DIFC only for business people?", answer: "No! DIFC has become a lifestyle destination with galleries, restaurants, and shopping that attracts visitors from across the city." },
      { question: "Are the galleries free to enter?", answer: "Yes, most galleries in DIFC are free to enter and open to the public. Just check opening hours as many close on Fridays." },
    ],
  ...
  },
  {
    ...
    description: "A new waterfront development at the historic Dubai Creek featuring the upcoming Dubai Creek Tower, stunning views, and modern living spaces.",
    highlights: ["Creek Views", "New Development", "Modern Living", "Harbour Promenade", "Creek Marina"],
    priceLevel: "$$$",
    imageUrl: null,
    imageAlt: "Dubai Creek Harbour waterfront",
    vibe: "Modern",
    introText: "Dubai Creek Harbour is one of Dubai's newest mega-developments, set to become a major destination when the Dubai Creek Tower (designed to surpass Burj Khalifa) is completed. Already, the area offers beautiful waterfront living with views of the historic creek, wildlife sanctuary, and the city skyline.",
    bestFor: ["Modern architecture fans", "Peace seekers", "Bird watchers", "New development enthusiasts"],
  ...
  },
  {
    ...
    description: "A premium master-planned community with an 18-hole championship golf course, Dubai Hills Mall, and lush green spaces perfect for families.",
  ...
  },
  {
    id: "al-barsha",
    name: "Al Barsha",
    description: "A centrally located residential area home to Mall of the Emirates and Ski Dubai. Offers great value with easy access to all major attractions.",
    highlights: ["Mall of Emirates", "Ski Dubai", "Central Location", "Value Hotels", "Metro Access"],
    priceLevel: "$$",
    imageUrl: null,
  ...
  },
  {
    ...
    description: "A family-friendly community with affordable housing options, community parks, and growing amenities. Ideal for long-term stays and budget-conscious travelers.",
    highlights: ["Affordable", "Community Parks", "Family Friendly", "Growing Amenities", "Local Vibe"],
    priceLevel: "$",
    imageUrl: null,
  ...
  },
  {
    id: "dubai-south",
    name: "Dubai South",
    description: "A rapidly developing area near Al Maktoum International Airport and Expo City Dubai. The future of Dubai with excellent investment potential.",
  ...
  },
  {
    ...
    description: "A lifestyle destination featuring Ain Dubai (the world's largest observation wheel), upscale dining, and stunning views of the Arabian Gulf.",
  ...
  },
  {
    ...
    description: "A multicultural community with themed clusters representing different countries. Known for affordable living and diverse dining options.",
  ...
  },
  {
    id: "al-karama",
    name: "Al Karama",
    description: "A bustling commercial area known for its shopping centers, textile shops, and diverse restaurants. A great place for budget shopping and authentic cuisine.",
