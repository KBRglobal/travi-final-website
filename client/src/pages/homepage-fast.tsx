...
function Header({ mobileMenuOpen, setMobileMenuOpen }: { mobileMenuOpen: boolean; setMobileMenuOpen: (v: boolean) => void }) {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 dark:bg-slate-950/95 backdrop-blur-sm border-b border-slate-100 dark:border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {mobileMenuOpen && (
          <nav className="md:hidden py-4 border-t border-slate-100 dark:border-slate-800" aria-label="Mobile navigation">
            <div className="flex flex-col gap-3">
              {NAV_ITEMS.map((item) => (
                <Link 
                  ...
                  className="px-2 py-2 text-base font-medium text-slate-700 dark:text-slate-300 hover:text-[#6443F4] transition-colors"
...
function HeroSection() {
  ...
  return (
    <section 
      className="relative min-h-screen flex items-center pt-20 pb-16 px-4 sm:px-6 lg:px-8 overflow-hidden bg-white dark:bg-slate-950" 
