...
export default function PrivacyPage() {
  ...
  const privacyFeatures = [
    {
      icon: Shield,
      title: t("pages.privacy.features.dataProtection.title"),
      description: t("pages.privacy.features.dataProtection.description"),
    },
    {
      icon: Lock,
      title: t("pages.privacy.features.minimalCollection.title"),
      description: t("pages.privacy.features.minimalCollection.description"),
    },
    {
      icon: Eye,
      title: t("pages.privacy.features.transparency.title"),
      description: t("pages.privacy.features.transparency.description"),
    },
    {
      icon: Database,
      title: t("pages.privacy.features.yourControl.title"),
      description: t("pages.privacy.features.yourControl.description"),
    },
  ];
    ...
    <PublicLayout>
      <div dir={isRTL ? "rtl" : "ltr"}>
            ...
            <Card className="border-l-4 border-l-[#6443F4]" data-testid="card-intro">
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  This Privacy Policy explains how KBR Global Creative Consulting Ltd ("TRAVI
                  World", "we", "us", "our") collects, uses, and protects information when you visit
                  https://travi.world (the "Website").
                </p>
                <p className="text-muted-foreground leading-relaxed mt-4">
                  We are committed to protecting your privacy and being transparent about our data
                  practices. Please read this policy carefully to understand how we handle your
                  information.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            <Card data-testid="section-who-we-are">
              ...
              <CardContent className="text-muted-foreground space-y-4">
                {/* OUT_OF_SCOPE: Legal body text */}
                <p>TRAVI World is a travel and tourism contents platform operated by:</p>
            ...
            <Card data-testid="section-information-collect">
              ...
              <CardContent className="text-muted-foreground space-y-4">
                {/* OUT_OF_SCOPE: Legal body text */}
                <p>We collect minimal information to operate our Website effectively:</p>

                <h3 className="font-medium text-foreground">2.1 Information You Provide</h3>
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    <strong>Newsletter Subscription:</strong> If you subscribe to our newsletter, we
                    collect your email address. This is voluntary and you can unsubscribe at any
                    time.
                  </li>
                  <li>
                    <strong>Contact Communications:</strong> If you contact us via email, we collect
                ...
                <p>Our Website does not require user registration or login. We do not collect:</p>
            ...
            <Card data-testid="section-how-we-use">
              ...
              <CardContent className="text-muted-foreground space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    <strong>Website Analytics:</strong> To understand how visitors use our Website,
                    identify popular contents, and improve user experience.
                  </li>
                  <li>
                    <strong>Newsletter Communications:</strong> To send travel updates, destination
                    highlights, and promotional contents to subscribers who have opted in.
                  </li>
                  <li>
                    <strong>Affiliate Performance:</strong> To track which affiliate links generate
                    bookings and calculate our commissions (no personal data is used for this
                    purpose).
                  </li>
                  <li>
                    <strong>Website Security:</strong> To protect against malicious activity, spam,
                    and security threats.
                  </li>
                  <li>
                    <strong>Legal Compliance:</strong> To comply with applicable laws and respond to
            ...
            <Card data-testid="section-legal-basis">
              ...
              <CardContent className="text-muted-foreground space-y-4">
                {/* OUT_OF_SCOPE: Legal body text */}
                <p>
                  For users in the European Economic Area (EEA) and United Kingdom, we process
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    ...
                    (analytics). You may withdraw consent at any time.
                  </li>
                  <li>
                    <strong>Legitimate Interests:</strong> For website security, fraud prevention,
                    and basic website functionality, where our interests do not override your
                    rights.
                  </li>
                  <li>
              ...
              <CardContent className="text-muted-foreground space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    ...
                    security, and cookie consent management. These cannot be disabled.
                  </li>
                  <li>
                    <strong>Analytics Cookies:</strong> Help us understand how visitors interact
                    with our Website. We use Google Analytics with IP anonymization enabled. These
                ...
                <p className="text-sm italic">
                  Please note that blocking certain cookies may impact your experience on the
                  Website.
                </p>
              </CardContent>
            </Card>
            ...
            <Card data-testid="section-third-party">
              ...
              <CardContent className="text-muted-foreground space-y-4">
                {/* OUT_OF_SCOPE: Legal body text */}
                <p>We work with trusted third-party service providers to operate our Website:</p>
                ...
                <p>Resend: Newsletter delivery service</p>

                <h3 className="font-medium text-foreground">6.3 Affiliate Partners</h3>
                <p>
                  When you click on affiliate links, you are redirected to third-party websites.
                ...
                <div className="bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4">
                  <p className="text-sm text-amber-800 dark:text-amber-200">
                    <strong>Important:</strong> When you leave our Website via an affiliate link,
                    the third party's privacy policy governs their collection and use of your data.
                    We do not receive any personal information about your bookings—only anonymous
                    confirmation that a booking was made (for commission purposes).
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card data-testid="section-ai-contents">
              ...
              <CardContent className="text-muted-foreground space-y-4">
                {/* OUT_OF_SCOPE: Legal body text */}
                <p>
                  Our Website uses artificial intelligence (AI) to generate and publish contents
                  automatically. This AI-generated contents:
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {[
            ...
            <Card data-testid="section-international-transfers">
              ...
              <CardContent className="text-muted-foreground space-y-4">
                {/* OUT_OF_SCOPE: Legal body text */}
                <p>
                  As we work with international service providers, your information may be
                ...
                <p>
                  For transfers from the EEA/UK, we ensure appropriate safeguards are in place,
                  including:
                </p>
                <ul className="list-disc pl-6 space-y-1">
            ...
            <Card data-testid="section-data-retention">
              ...
              <CardContent className="text-muted-foreground space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    <strong>Analytics Data:</strong> 14 months (Google Analytics default retention
                    period)
                  </li>
                  <li>
                    <strong>Newsletter Subscriptions:</strong> Until you unsubscribe, plus a
                    suppression list to honor your opt-out
                  </li>
                  <li>
                    <strong>Contact Communications:</strong> Up to 2 years for customer service
                    purposes
                  </li>
                  <li>
                    <strong>Server Logs:</strong> 90 days for security purposes
                  </li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card data-testid="section-privacy-rights">
              ...
              <CardContent className="text-muted-foreground space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    <strong>Right to Withdraw Consent:</strong> Withdraw consent at any time (e.g.,
                    unsubscribe from newsletter, reject cookies).
                  </li>
                </ul>
                <p>
                ...
                <p className="text-sm">
                  We will respond to your request within 30 days. If you are not satisfied with our
            ...
            <Card data-testid="section-california-rights">
              ...
              <CardContent className="text-muted-foreground space-y-4">
                ...
                <p>
                  We do not sell your personal information for monetary consideration. Analytics
                  cookies may constitute "sharing" under CPRA; you can opt-out via our cookie
                  consent tool or by clicking "Do Not Sell or Share My Personal Information" in the
                  website footer.
                </p>
              </CardContent>
            </Card>
            ...
            <Card data-testid="section-children-privacy">
              ...
              <CardContent className="text-muted-foreground space-y-4">
                {/* OUT_OF_SCOPE: Legal body text */}
                <p>
                  Our Website is intended for users aged 13 years and older. We do not knowingly
            ...
            <Card data-testid="section-changes">
              ...
              <CardContent className="text-muted-foreground space-y-4">
                ...
                <p>
                  Your continued use of the Website after changes take effect constitutes acceptance
            ...
            <Card data-testid="section-contact">
              ...
              <CardContent className="text-muted-foreground space-y-4">
                ...
                <p className="text-sm">
                  <strong>EEA/UK Representative:</strong> If you are located in the European
                  Economic Area or United Kingdom and have concerns about our data practices, you
        ...
        <section className="py-8 bg-white dark:bg-background">
          <div
            className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-sm text-muted-foreground"
