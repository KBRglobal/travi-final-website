          ...
          <CardContent className="p-5 bg-white dark:bg-slate-800/80">
            ...
            <div className="flex items-center justify-between pt-3 border-t border-slate-200 dark:border-slate-700/50">
              ...
              <span className="flex items-center text-[#6443F4] font-semibold text-sm transition-all duration-300 group-hover:gap-2">
                View Hotels
                <ArrowRight className="w-4 h-4 ml-1 transform group-hover:translate-x-1 transition-transform duration-300" aria-hidden="true" />
              </span>
            </div>
          </CardContent>
        </Card>
    ...
    <>
      ...
      <div className="min-h-screen bg-white dark:bg-slate-950 relative">
        ...
        <main className="relative z-10">
          ...
          <section className="py-16 sm:py-20 px-4 sm:px-6 bg-gradient-to-b from-white via-slate-50/50 to-white dark:from-slate-950 dark:via-slate-900/50 dark:to-slate-950" data-testid="hotel-categories">
                  ...
                  >
                    <Card className="p-6 h-full bg-white dark:bg-slate-800/60 border-2 border-slate-100 dark:border-slate-700/50 shadow-lg hover:shadow-2xl hover:border-[#6443F4]/30 dark:hover:border-[#6443F4]/30 transition-all duration-500 hover:-translate-y-1 group">
                      <div className="flex flex-col h-full">
                        ...
                        <p className="text-sm text-[#6443F4] font-semibold mb-3">{category.subtitle}</p>
          ...
          <section className="py-16 sm:py-20 px-4 sm:px-6 bg-white dark:bg-slate-950" data-testid="amenities-section">
            <div className="max-w-7xl mx-auto">
              <motion.div
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
          ...
          <section className="py-20 sm:py-24 px-4 sm:px-6 relative overflow-hidden" data-testid="cta-section">
