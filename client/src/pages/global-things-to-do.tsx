...
const allActivities: Activity[] = [
  {
    ...
    description:
      "Experience the thrill of dune bashing followed by a magical sunset in the desert with traditional entertainment and BBQ feast.",
    category: "adventure",
  ...
  },
  {
    ...
    description:
      "Skip the lines and explore the world's largest art museum with an expert art historian guide.",
    category: "culture",
  ...
  },
  {
    ...
    description:
      "Discover hidden culinary gems in Tokyo's vibrant neighborhoods with a local foodie guide.",
    category: "dining",
  ...
  },
  {
    ...
    description:
      "Explore America's most iconic monument with ferry access and guided historical commentary.",
    category: "tours",
  ...
  },
  {
    ...
    description:
      "Combine the iconic London Eye experience with a scenic cruise along the River Thames.",
    category: "family",
  ...
  },
  {
    ...
    description:
      "Witness the spectacular light and sound show at Singapore's iconic Supertree Grove.",
  ...
  },
  {
    ...
    description:
      "Ascend to the world's tallest building and enjoy panoramic views from the 148th floor.",
    category: "adventure",
    categoryLabel: "Adventure",
    duration: "2 hours",
    location: "Dubai",
  ...
  },
  {
    ...
    description:
      "Romantic evening cruise with gourmet French cuisine and stunning views of illuminated Paris.",
    category: "dining",
    categoryLabel: "Food & Dining",
    duration: "3 hours",
    location: "Paris",
  ...
  },
  {
    ...
    description:
      "Discover centuries of British royal history with expert-guided tours of iconic landmarks.",
    category: "culture",
    categoryLabel: "Culture & Arts",
    duration: "6 hours",
    location: "London",
  ...
  },
  {
    ...
    description:
      "Access the iconic infinity pool viewpoint with stunning city and harbor panoramas.",
    category: "photography",
    categoryLabel: "Photo Spots",
    duration: "1 hour",
    location: "Singapore",
  ...
  },
  {
    ...
    description:
      "Sample the freshest seafood and traditional Japanese delicacies at Tokyo's famous market.",
    category: "dining",
    categoryLabel: "Food & Dining",
    duration: "3 hours",
    location: "Tokyo",
...
export default function GlobalThingsToDo() {
  ...
  const filteredActivities = allActivities.filter(activity => {
    ...
    const matchesLocation =
      ...
      activity.location.toLowerCase().replace(" ", "-") === selectedLocation;
    const matchesSearch =
      !searchQuery ||
  ...
  const getActivitiesByDuration = (tierId: string) => {
    ...
    switch (tierId) {
      case "quick":
        return allActivities.filter(a => parseInt(a.duration) <= 2);
      case "half-day":
        return allActivities.filter(a => parseInt(a.duration) >= 3 && parseInt(a.duration) <= 4);
      case "full-day":
        return allActivities.filter(a => parseInt(a.duration) >= 5 && parseInt(a.duration) <= 6);
      case "multi-day":
        return allActivities.filter(a => parseInt(a.duration) > 6);
      default:
  ...
  return (
    <PublicLayout>
      <SEOHead
        title="Things to Do Worldwide - Tours, Activities & Experiences | TRAVI"
        description="Discover curated tours, activities and unique experiences across Dubai, Paris, Tokyo, New York, London and Singapore. Desert safaris, museum tours, street food walks and family adventures."
      ...
      <section
        ref={heroRef}
        className="relative bg-white dark:bg-slate-950 py-20 lg:py-28 overflow-hidden"
        data-testid="hero-things-to-do"
      >
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <Badge
                className="mb-4 px-4 py-1.5 bg-[#6443F4]/10 text-[#6443F4] border-0 rounded-full"
            ...
            >
              {allActivities
                .filter(a => a.featured)
                .concat(allActivities.slice(2, 4))
                .slice(0, 4)
                .map((activity, i) => (
                  <div
                    key={activity.id + "-" + i}
      ...
      {/* Category Pills */}
      <section
        className="sticky top-0 z-40 py-5 bg-white/95 dark:bg-slate-950/95 backdrop-blur-md border-b border-slate-100 dark:border-slate-800"
        data-testid="section-category-pills"
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <motion.div
            ...
            {activityCategories.map((category, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <IconComponent
                      className={`w-4 h-4 ${isActive ? "text-white" : "text-[#6443F4]"}`}
                    />
                  </motion.div>
      ...
      <section
        className="py-20 lg:py-28 bg-slate-50 dark:bg-slate-900"
        data-testid="section-activity-categories"
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <motion.div
            className="mb-12"
                  ...
                  <Link href={`/things-to-do/collection/${featuredCollections[0].id}`}>
                    ...
                    >
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-8 lg:p-10">
                        ...
                        <h3
                          className="text-2xl lg:text-3xl font-bold text-white mb-3 group-hover:translate-x-2 transition-transform duration-300"
                          style={{ fontFamily: "'Chillax', var(--font-sans)" }}
                        >
                    ...
                    >
                      ...
                      <div className="absolute inset-0 p-5 flex items-center gap-5">
                        ...
                        <div className="flex-1 min-w-0">
                          <h3
                            className="text-lg font-bold text-white mb-1 group-hover:translate-x-1 transition-transform"
                            style={{ fontFamily: "'Chillax', var(--font-sans)" }}
                          >
                            {collection.title}
                          </h3>
      ...
      {/* Featured Activities */}
      <section
        className="py-20 lg:py-28 bg-white dark:bg-slate-950 overflow-hidden"
        data-testid="section-featured-activities"
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <motion.div
          ...
          >
            <div>
              ...
              <p className="text-slate-600 dark:text-slate-400">
                {filteredActivities.length} handpicked{" "}
        ...
        {filteredActivities.length > 0 ? (
            ...
            <div className="relative">
                      ...
                      >
                        ...
                        <div className="relative aspect-[4/3] overflow-hidden">
                          ...
                          <div className="absolute top-4 left-4 right-4 flex items-center justify-between">
                            <Badge className="bg-[#6443F4]/10 backdrop-blur-md border-0 shadow-lg px-3 py-1.5 text-[#6443F4] rounded-full">
                        ...
                        <div className="p-6">
                          ...
                          <div className="flex items-center justify-between pt-4 border-t border-slate-100 dark:border-slate-700">
                            ...
                            <span className="text-lg font-bold text-[#6443F4]">
                              {activity.price}
                            </span>
                          </div>
                        </div>
              ...
              <div className="flex justify-center gap-2 mt-6">
                {filteredActivities.slice(0, 5).map((_, i) => (
                  <div
                    key={i}
                    className={`w-2 h-2 rounded-full ${i === 0 ? "bg-[#6443F4]" : "bg-slate-200 dark:bg-slate-700"}`}
                  />
                ))}
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div
              className="text-center py-20 bg-slate-50 dark:bg-slate-900 rounded-3xl"
      ...
      <section
        className="py-20 lg:py-28 bg-slate-50 dark:bg-slate-900"
        data-testid="section-by-location"
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <motion.div
          ...
          >
            <Badge
              className="mb-4 px-4 py-1.5 bg-[#6443F4]/10 text-[#6443F4] border-0 rounded-full"
              data-testid="badge-destinations"
            >
          ...
          >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 lg:gap-6">
              {locationFilters
                .filter(l => l.id !== "all")
                .map((location, index) => {
                  const locationActivities = allActivities.filter(
                    a => a.location.toLowerCase().replace(" ", "-") === location.id
                  );
                      ...
                      <Link href={`/destinations/${location.id}/things-to-do`}>
                        ...
                        >
                          ...
                          <div className="relative overflow-hidden rounded-2xl aspect-[3/4]">
                            <img
                              src={(location as any).image || `/cards/default-destination.webp`}
                              alt={location.name}
                          ...
                          {/* Hover expansion */}
                          <motion.div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 bg-white dark:bg-slate-800 rounded-full px-4 py-2 shadow-xl opacity-0 group-hover:opacity-100 group-hover:bottom-[-36px] transition-all duration-300 whitespace-nowrap">
      ...
      <section
        ...
        data-testid="section-by-duration"
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <motion.div
            className="mb-12"
          ...
          >
            ...
            <div
              className="absolute top-1/2 left-0 h-1 bg-[#6443F4] rounded-full -translate-y-1/2 hidden lg:block"
              style={{ width: "100%" }}
            />
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-8">
              {durationTiers.map((tier, index) => {
                ...
                return (
                  <motion.div key={tier.id} variants={fadeInUp} className="relative">
                    <motion.button
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-slate-600 dark:text-slate-400">
                          {tierActivities.length} activities
                        </span>
                        <motion.div animate={{ x: isSelected ? 5 : 0 }}>
          ...
          {selectedDuration && (
            ...
            >
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {getActivitiesByDuration(selectedDuration)
                  .slice(0, 6)
                  .map(activity => (
                    <Link key={activity.id} href={`/things-to-do/${activity.id}`}>
                      ...
                      >
                        ...
                        />
                        <div className="flex-1 min-w-0">
                          <h4 className="font-semibold text-slate-900 dark:text-white group-hover:text-[#6443F4] transition-colors line-clamp-1">
                            {activity.title}
                          </h4>
      ...
      <section
        className="py-20 lg:py-28 bg-slate-50 dark:bg-slate-900"
        data-testid="section-planning-tools"
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <motion.div
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-white/80 text-lg mb-8 max-w-md">
                    Let AI craft your perfect itinerary based on your interests, budget, and travel
                    style.
                  </p>
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <Badge className="bg-[#6443F4]/10 text-[#6443F4] border-0 rounded-full">
                      Save 30%
                    </Badge>
                  </div>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <span className="text-sm text-slate-500 dark:text-slate-400 ml-2">
                              {bundle.count} activities
                            </span>
                          </div>
                        </div>
                        <Badge
                          variant="outline"
                          className="bg-[#6443F4]/10 text-[#6443F4] border-[#6443F4]/20 rounded-full"
                        >
                          Save {bundle.savings}
                        </Badge>
                      </motion.div>
      ...
      {/* Newsletter Section */}
      <section
        className="py-20 lg:py-28 bg-white dark:bg-slate-950 relative overflow-hidden"
            ...
            <div className="bg-slate-900 dark:bg-slate-800 rounded-[2rem] lg:rounded-[3rem] p-8 lg:p-16 overflow-hidden">
              ...
              <div className="relative z-10 max-w-2xl mx-auto text-center">
                ...
                <p className="text-lg lg:text-xl text-white/70 mb-10">
                  Join 50,000+ explorers getting weekly inspiration, exclusive deals, and insider
                  tips.
                </p>
                ...
                <p className="text-sm text-white/40 mt-6">No spam, ever. Unsubscribe anytime.</p>
