...
const HOTEL_DESTINATIONS = [
  ...
  },
  {
    ...
    imageAlt:
      "Hotels in Shinjuku, Shibuya and Ginza districts with Tokyo Tower and Mount Fuji views",
    seoDescription:
      "Best Tokyo hotels in Shinjuku, Shibuya, Ginza near Tokyo Tower and Sensoji Temple",
    featured: true,
  },
  {
    slug: "singapore",
  ...
  },
  {
    ...
    seoDescription:
      "Cheap and luxury Bangkok hotels near Grand Palace, Khao San Road and Sukhumvit",
    featured: false,
  },
  {
    slug: "barcelona",
    ...
    imageAlt:
      "Beachfront hotels on Barceloneta and accommodations near Sagrada Familia and La Rambla",
  ...
  },
  {
    ...
    seoDescription:
      "Amsterdam hotels on canals near Rijksmuseum, Anne Frank House and Red Light District",
    featured: false,
  },
  {
    slug: "hong-kong",
  ...
  },
  {
    ...
    imageAlt:
      "Bosphorus view hotels in Sultanahmet near Blue Mosque, Hagia Sophia and Grand Bazaar",
    seoDescription:
      "Istanbul hotels in Sultanahmet near Blue Mosque, Hagia Sophia and Taksim Square",
    featured: false,
  },
  {
    slug: "las-vegas",
    ...
    imageAlt:
      "Casino resort hotels on Las Vegas Strip including Bellagio, Venetian and Caesars Palace",
    seoDescription:
      "Las Vegas Strip hotels and resorts - Bellagio, Venetian, MGM Grand and Caesars Palace",
    featured: false,
  },
  {
    slug: "los-angeles",
    ...
    imageAlt:
      "Hotels in Hollywood, Beverly Hills, Santa Monica beach and near Universal Studios LA",
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm">
            {destinations.length} popular{" "}
            {destinations.length === 1 ? "destination" : "destinations"} for travelers
          </p>
        </div>
      </div>
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Find the best hotels near top attractions in Dubai, Paris, London, New York, Tokyo and more. Compare 10,000+ hotels from $25/night budget stays to luxury 5-star resorts with real reviews."
        />
        ...
        <meta
          property="og:title"
          content="Best Hotels in Dubai, Paris, London & Tokyo - Compare 10,000+ Properties"
        />
        <meta
          property="og:description"
          content="Find where to stay in the world's top destinations. Hotels near Burj Khalifa, Eiffel Tower, Times Square and more from $25/night."
        />
        ...
        <meta
          ...
          content="Compare 10,000+ hotels in 17 destinations. From $25/night."
        />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            description:
              "Top 17 cities for hotels - Dubai, Paris, London, New York, Tokyo and more",
                ...
                <div className="grid lg:grid-cols-2 gap-8 items-center">
                  ...
                  <div className="flex flex-col justify-center px-6 sm:px-12 lg:px-16 xl:px-24 order-1">
                    ...
                    >
                      <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-white dark:bg-slate-800 shadow-lg shadow-[#6443F4]/10 border border-[#6443F4]/20">
                        ...
                        <span
                          ...
                          data-testid="badge-hotels-count"
                        >
                          Compare{" "}
                          <span className="text-[#6443F4]">{totalHotels.toLocaleString()}+</span>{" "}
                          hotels in 17 cities
                        </span>
                      </div>
                    </motion.div>
                    ...
                    >
                      ...
                      in Dubai, Paris, London, Tokyo and 12 more destinations.
                    </motion.p>
                    ...
                    >
                      <div className="relative flex items-center bg-white dark:bg-slate-900 rounded-2xl shadow-xl shadow-slate-200/50 dark:shadow-slate-900/50 border border-slate-100 dark:border-slate-800">
                        <div
                          className="absolute left-5 w-10 h-10 rounded-xl bg-gradient-to-br from-[#6443F4] to-[#8B5CF6] flex items-center justify-center shadow-lg shadow-[#6443F4]/30"
                          aria-hidden="true"
                        >
                    ...
                    >
                      ...
                      {[
                        ...
                        },
                        {
                          ...
                          slug: "paris",
                          color:
                            "bg-pink-50 text-pink-700 hover:bg-pink-100 dark:bg-pink-900/30 dark:text-pink-300",
                        },
                        {
                          name: "London",
                          slug: "london",
                            ...
                            <div className="flex items-center justify-between">
                              <div>
                                ...
                                <span className="text-3xl font-bold text-white ml-2">
                                  {dest.priceRange.split("-")[0]}
                                </span>
                                <span className="text-white/60 text-sm">/night</span>
                              </div>
                              <Link href={localePath(`/hotels/${dest.slug}`)}>
                                <button className="inline-flex items-center gap-2 px-8 py-4 rounded-[--radius-card] bg-white text-slate-900 font-bold hover:bg-[#6443F4]/10 hover:text-[#6443F4] transition-all shadow-xl hover:shadow-2xl hover:scale-105 transform">
                                  View Hotels
                  ...
                  >
                    <Card className="p-5 h-full bg-white dark:bg-slate-800/60 border border-slate-200/80 dark:border-slate-700/50 shadow-sm hover:shadow-lg transition-all duration-300">
                      <div className="flex flex-col h-full">
                        ...
                        <p className="text-xs text-[#6443F4] font-medium mb-2">
                          {category.subtitle}
                        </p>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid sm:grid-cols-3 gap-4">
                <Link
                  ...
                  className="flex items-center gap-2 p-3 rounded-lg bg-slate-50 dark:bg-slate-800/50 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
                >
            ...
            <div className="max-w-3xl mx-auto text-center relative z-10">
              ...
              >
                ...
                <p className="text-white/85 text-base sm:text-lg mb-8 max-w-xl mx-auto leading-relaxed">
                  Compare prices and find the best deals on hotels in Dubai, Paris, London and more
                  top destinations.
                </p>
      ...
      <nav className="sr-only" aria-label="All hotel destinations">
              ...
              {HOTEL_DESTINATIONS.filter(d => d.region === region.name).map(dest => (
                <li key={dest.slug}>
                  <a href={localePath(`/hotels/${dest.slug}`)}>
                    Hotels in {dest.name} - {dest.seoDescription} |{dest.hotelCount} properties from{" "}
                    {dest.priceRange}/night
                  </a>
                </li>
              ))}
            </ul>
        ...
        <ul>
          <li>
            <a href={localePath("/attractions")}>Tourist Attractions Worldwide</a>
          </li>
          <li>
