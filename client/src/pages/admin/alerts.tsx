...
export default function AlertsDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[hsl(var(--admin-bg))]" data-testid="alerts-dashboard">
      <div className="border-b border-[hsl(var(--admin-border))] bg-white">
        <div className="px-6 py-4 flex items-center justify-between">
          <div>
            <h1 className="text-xl font-semibold text-[hsl(var(--admin-text))]">System Alerts</h1>
          ...
          >
            <RefreshCw
              className={cn("h-4 w-4 mr-2", (loadingActive || loadingStats) && "animate-spin")}
            />
            Refresh
          </Button>
        </div>
