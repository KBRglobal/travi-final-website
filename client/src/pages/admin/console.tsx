    ...
    <div className="min-h-screen bg-[hsl(var(--admin-bg))]">
      <div className="border-b border-[hsl(var(--admin-border))] bg-white">
        <div className="px-6 py-4 flex items-center justify-between">
          <div>
            <h1
              className="text-xl font-semibold text-[hsl(var(--admin-text))] flex items-center gap-3"
              data-testid="heading-console"
            >
      ...
      <div className="p-6 space-y-6">
        <div className="p-4 bg-muted rounded-lg border border-[hsl(var(--admin-border))]">
          <h3 className="font-medium flex items-center gap-2 mb-2">
            <Lightbulb className="h-4 w-4 text-primary" />
            How It Works
          </h3>
          <p className="text-sm text-muted-foreground">
            Monitor <strong>real-time system activity</strong>: AI generation, RSS imports,
            scheduled tasks, errors, and more. Use this to debug issues and ensure everything is
            running smoothly.
          </p>
        </div>
