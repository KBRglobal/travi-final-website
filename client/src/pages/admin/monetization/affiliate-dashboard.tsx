      ...
      <div>
        ...
        <div className="mt-4 p-4 bg-muted rounded-lg border">
          ...
          <p className="text-sm text-muted-foreground">
            Affiliate links are <strong>automatically inserted</strong> into your content based on
            type (hotels = Booking.com, attractions = GetYourGuide, dining = TripAdvisor). Track
            clicks, conversions, and earned commissions here.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Links currently embedded in your contents</CardDescription>
          </CardHeader>
          <CardContent>
