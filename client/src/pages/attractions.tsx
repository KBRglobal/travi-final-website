...
import { 
  ...
  Ticket, TrendingUp, Globe2, ArrowRight, Sparkles, Camera, Globe,
  Building2, Utensils
} from "lucide-react";
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta property="og:title" content="Things to Do & Attractions – Skip-the-Line Tickets Worldwide" />
        <meta property="og:description" content={pageDescription} />
        <meta property="og:url" content={CANONICAL_URL} />
        <meta property="og:image" content={`${BASE_URL}/attractions-hero/eiffel-tower-paris-attraction.webp`} />
        <meta property="og:image:alt" content="Eiffel Tower Paris - Skip-the-line tickets to top attractions worldwide" />

        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Things to Do & Attractions Worldwide" />
        <meta name="twitter:description" content="Skip-the-line tickets to Eiffel Tower, Colosseum, Burj Khalifa and more" />
                                ...
                                >
                                  ...
                                  <div className="flex-1 min-w-0">
                                    <div className="flex items-center gap-2">
                                      ...
                                      <span className="font-medium text-slate-900 dark:text-white truncate" data-testid={`text-result-${result.id}`}>{result.title}</span>
                                    </div>
                                    <p className="text-sm text-slate-500 dark:text-slate-400 truncate">{result.subtitle}</p>
                                    {result.rating && (
                                      <div className="flex items-center gap-1 mt-1">
                                        <Star className="w-3.5 h-3.5 text-yellow-400 fill-yellow-400" />
                                        <span className="text-xs text-slate-600 dark:text-slate-300">{result.rating.toFixed(1)}</span>
                                      </div>
                                    )}
                                  </div>
                      ...
                      >
                        ...
                        <div className="absolute inset-0 p-6 sm:p-8 flex flex-col justify-between">
                          ...
                          >
                            ...
                            {/* Title */}
                            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-2">{dest.name}</h2>
