            ...
            >
              <div className="aspect-[4/3] relative overflow-hidden">
                ...
                <div className="absolute top-3 left-3">
                  <Badge
                    variant="secondary"
                    className="bg-white/95 backdrop-blur-sm text-foreground border-0 font-semibold"
                  >
                    #{index + 1}
                  </Badge>
                </div>
              ...
              <CardContent className="p-4 md:p-5 space-y-2">
                <h3 
                  className="font-semibold text-base md:text-lg line-clamp-2 group-hover:text-[#6443F4] transition-colors"
                  style={{ fontFamily: "'Chillax', var(--font-sans)" }}
                >
                  {item.title}
                </h3>
