...
export function HeroSection({ imageSlot, title, subtitle }: HeroSectionProps) {
  return (
    <section 
      className="relative w-full min-h-[60vh] md:min-h-[70vh] lg:min-h-[80vh] bg-muted overflow-hidden"
      data-testid="section-hero"
    >
      <div className="absolute inset-0">
        {imageSlot}
      </div>
      <div className="relative container mx-auto px-4 md:px-6 lg:px-8 py-16 md:py-24 flex flex-col justify-end min-h-[60vh] md:min-h-[70vh] lg:min-h-[80vh]">
