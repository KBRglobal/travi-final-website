    ...
    " hover-elevate active-elevate-2",
  {
    variants: {
      variant: {
        ...
        brand:
          "text-white border-2 border-[#24103E] rounded-[--radius-card] bg-[#6443F4] hover:bg-[#5539d4] shadow-[0_4px_15px_rgba(100,67,244,0.3)]",
        // TRAVI secondary button - white with dark border
        "brand-secondary":
          "text-[#24103E] border-2 border-[#24103E] rounded-[--radius-card] bg-white hover:bg-slate-50 shadow-[0_4px_15px_rgba(36,16,62,0.1)]",
